    ...
    Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            try {
                ...
                //获得最后一次变化的位置
                if (ActivityCompat.checkSelfPermission(OutdoorCyclingActivityStar.this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(OutdoorCyclingActivityStar.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
