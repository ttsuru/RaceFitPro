...
public class B18IOutsideLineRenderer extends B18IAbsRenderer {
    ...
    public B18IOutsideLineRenderer(Context context, View view) {
        super(context, view);
    }
    ...
    public void drawCoordinateText(Canvas canvas, Axis axisX, Axis axisY, int moveX) {
        if(axisX != null && axisY != null){
            ...
            List<B18iAxisValue> valuesX = axisX.getValues();
            if(axisX.isShowText()){
                for (int i = 0; i < valuesX.size(); i++) {
                    B18iAxisValue value = valuesX.get(i);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            List<B18iAxisValue> valuesY = axisY.getValues();
            if(axisY.isShowText()){
                for (B18iAxisValue value : valuesY){
                    float textW = coordPaint.measureText(value.getLabel());
