...
public class XieYangThereFragment extends BaseFragment {

    @BindView(R.id.tabs_dtarepot_xieyangthere) TabLayout tabs;
    @BindView(R.id.chart_shumian_xieyangthere) ColumnChartView stepChart;
    ...
    protected int getContentViewId() {
        return R.layout.fragment_xieyangthere;
    }
    ...
    private void getData(String date) {
        ...
        OkHttpObservable.getInstance().getData(commonSubscriber, URLs.HTTPs+URLs.getBloodOxygenM, mapjson);
    }
}
