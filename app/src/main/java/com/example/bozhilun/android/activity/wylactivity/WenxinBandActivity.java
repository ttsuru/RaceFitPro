        ...
        switch (v.getId()) {
            ...
            case R.id.xinxin_bangdin:
                ...
                if (is == true) {//取得蓝牙地址
                    ...
                    JsonRequest<JSONObject> jsonRequest = new JsonObjectRequest(Request.Method.GET, "http://wx.berace.com.cn/wx/web/bind?mac=" + "D9:78:2A:CF:C9:9F", null,
                            new Response.Listener<JSONObject>() {
                                @Override
                                public void onResponse(JSONObject response) {
                                    System.out.print("yyyyyyyyyyyyyyyyy" + response);
                                    try {
                                        if (response.optString("resultCode").equals("001")) {
                                           ...
                                           // Toast.makeText(WenxinBandActivity.this, getResources().getString(R.string.Bind_failed), Toast.LENGTH_SHORT).show();
                                        }
                                    } catch (Exception e) {
                                        e.printStackTrace();
                                    }
