...
public class WatchAccessServices extends AccessibilityService {
    ...
    private void sendMsgW30S(String h9Msg, int type) {
        //================== 消息推送类型===========================
//        static final int NotifaceMsgPhone = 0x01;//来电提醒
//        static final int NotifaceMsgQq = 0x02;//QQ
//        static final int NotifaceMsgWx = 0x03;//微信
//        static final int NotifaceMsgMsg = 0x04;//短消息
//        static final int NotifaceMsgSkype = 0x05;//Skype
//        static final int NotifaceMsgWhatsapp = 0x06;//Whatsapp
//        static final int NotifaceMsgFacebook = 0x07;//脸书
//        static final int NotifaceMsgLink = 0x08;//Link
//        static final int NotifaceMsgTwitter = 0x09;//推特
//        static final int NotifaceMsgViber = 0x0a;//Viber
//        static final int NotifaceMsgLine = 0x0b;//Line
        boolean w30sswitch_skype = (boolean) SharedPreferenceUtil.get(MyApp.getApplication(), "w30sswitch_Skype", false);
        boolean w30sswitch_whatsApp = (boolean) SharedPreferenceUtil.get(MyApp.getApplication(), "w30sswitch_WhatsApp", false);
        boolean w30sswitch_facebook = (boolean) SharedPreferenceUtil.get(MyApp.getApplication(), "w30sswitch_Facebook", false);
        boolean w30sswitch_linkendIn = (boolean) SharedPreferenceUtil.get(MyApp.getApplication(), "w30sswitch_LinkendIn", false);
        boolean w30sswitch_twitter = (boolean) SharedPreferenceUtil.get(MyApp.getApplication(), "w30sswitch_Twitter", false);
        boolean w30sswitch_viber = (boolean) SharedPreferenceUtil.get(MyApp.getApplication(), "w30sswitch_Viber", false);
        boolean w30sswitch_line = (boolean) SharedPreferenceUtil.get(MyApp.getApplication(), "w30sswitch_LINE", false);
        boolean w30sswitch_weChat = (boolean) SharedPreferenceUtil.get(MyApp.getApplication(), "w30sswitch_WeChat", false);
        boolean w30sswitch_qq = (boolean) SharedPreferenceUtil.get(MyApp.getApplication(), "w30sswitch_QQ", false);
        boolean w30sswitch_msg = (boolean) SharedPreferenceUtil.get(MyApp.getApplication(), "w30sswitch_Msg", false);
        boolean w30sswitch_Phone = (boolean) SharedPreferenceUtil.get(MyApp.getApplication(), "w30sswitch_Phone", false);

        switch (type) {
            case 0x02:
                if (w30sswitch_qq){
                    sendW30SApplicationMsg(h9Msg, type);
                }
                break;
            case 0x03:
    ...
    public void sendW30SApplicationMsg(String h9Msg, int type) {
        String mylanya = (String) SharedPreferenceUtil.get(MyApp.getApplication(), "mylanya", "");
        if (!TextUtils.isEmpty(mylanya) && mylanya.equals("W30")) {
