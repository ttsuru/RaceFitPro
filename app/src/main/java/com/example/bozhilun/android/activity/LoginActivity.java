            ...
            case R.id.login_btn:
                ...
                if (lauage) {   //中文
                    ...
                    if (!WatchUtils.isEmpty(usernametxt) && !WatchUtils.isEmpty(pass)) {
                        ...
                        ToastUtil.showToast(LoginActivity.this, "Please enter your account number and password");
                    }
                }
...
//有效时期
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e(TAG, "-----packname=" + WatchUtils.getAppInfo(LoginActivity.this));
    }
