...
/**
 * @aboutContent: 自定义水平\垂直电池控件
 * @author： 安
 * @crateTime: 2017/12/15 17:30
...
public class BatteryView extends View {
    ...
    private void drawHorizontalBattery(Canvas canvas) {
        ...
        //Log.e("BatteryView","-----width---"+strokeWidth+"--="+offset+"-="+(height-strokeWidth)+"\n"+"--="+(strokeWidth+1)+"--="+(offset+1)+"--="+((height-strokeWidth)-1));
        //RectF r2 = new RectF(strokeWidth, strokeWidth, offset, height - strokeWidth);
        RectF r2 = new RectF(strokeWidth+1, strokeWidth+1, offset-1, (height - strokeWidth)-1);
        //根据电池电量决定电池内矩形电量颜色
        if (mPower < 30) {
