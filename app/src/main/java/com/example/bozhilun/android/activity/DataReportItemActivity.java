...
public class DataReportItemActivity extends BaseActivity {
    @BindView(R.id.tv_title)
    TextView tvTitle;
    @BindView(R.id.stepitem_viewpager)
    ViewPager stepitemViewpager;
    ...
    protected void initViews() {
        tvTitle.setText(getResources().getString(R.string.activity_repor));
        ...
        fragments.add(new DataReportStepItemFragment());
        fragments.add(new DataReportStepWeekFragment());
        fragments.add(new DataReportStepMoothFragment());
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        toolbar.setOnMenuItemClickListener(new Toolbar.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                ScreenShot.shoot(DataReportItemActivity.this, new File(filePath));
                Common.showShare(DataReportItemActivity.this, null, false,filePath);}
                return true;
            }
        });
        return true;
    ...
    protected int getContentViewId() {
        return R.layout.activity_datareport_item;
    }
}
