            ...
            public void onNext(String result) {
                try {
                    ...
                    if ("001".equals(resultCode)) {
                        data_type_text.setVisibility(View.GONE);
                        try {
                            ...
                            for (int i = 0; i < JSONObjectArray.length(); i++) {
                                ...
                                String distance = jo.optString("distance").toString().trim();//总公里
                                ...
                                boolean w30sunit = (boolean) SharedPreferenceUtil.get(SportsHistoryActivity.this, "w30sunit", true);
                                if (w30sunit) {
                                    map.put("zonggongli", Math.round(Double.valueOf(distance)) + "Km");//总公里
                                } else {
                                    map.put("zonggongli",  Math.round((Double.valueOf(distance) * 1000 * 3.28))+" ft");//总公里
                                }
                                ...
                                if ("0".equals(type)) {
                                    ...
                                    map.put("image", R.mipmap.image_w30s_qixing_run);//跑步-骑行
                                }
                                if (w30sunit) {
                                    map.put("chixugongli", Math.round(Double.valueOf(distance)) + "Km");//持续公里数
                                } else {
                                    map.put("chixugongli",  Math.round((Double.valueOf(distance) * 1000 * 3.28))+" ft");///持续公里数
                                }
                                ...
                                if ("0".equals(type)) {
                                    ...
                                    mapb.put("image", R.mipmap.image_w30s_qixing_run);//跑步-骑行
                                }
                                if (w30sunit) {
                                    map.put("chixugongli", Math.round(Double.valueOf(distance)) + "Km");//总公里
                                } else {
                                    map.put("chixugongli", Math.round((Double.valueOf(distance) * 1000 * 3.28))+" ft");//总公里
                                }
                        ...
                        data_type_text.setVisibility(View.VISIBLE);
                    }
