...
import com.example.bozhilun.android.fragment.XieYangFragment;
import com.example.bozhilun.android.fragment.XieYangThereFragment;
import com.example.bozhilun.android.fragment.XieyangTwoFragment;
...
public class DataReportItemXieYangActivity extends BaseActivity {
    ...
    @Override
    protected int getStatusBarColor() {return R.color.xinmosi;}//设置toobar颜色
    @Override
    protected void initViews() {
        tvTitle.setText(getResources().getString(R.string.bloodoxygen_repor));
        ...
        fragments.add(new XieYangFragment());
        fragments.add(new XieyangTwoFragment());
        fragments.add(new XieYangThereFragment());
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        toolbar.setOnMenuItemClickListener(new Toolbar.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                ScreenShot.shoot(DataReportItemXieYangActivity.this, new File(filePath));
                Common.showShare(DataReportItemXieYangActivity.this, null, false,filePath);}//
                return true;
            }
        });
        return true;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        //theremakingofbooksnordoesthroughtenturies
        return super.onOptionsItemSelected(item);
    }

    @Override
    protected int getContentViewId() {
        return R.layout.activity_datareport_xieyang_item;
    }
}
