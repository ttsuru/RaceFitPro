        ...
        switch (state) {
            case TelephonyManager.CALL_STATE_IDLE:      // 电话挂断
                if (phoneStateListenerInterface != null) {
                    phoneStateListenerInterface.callPhoneData(TelephonyManager.CALL_STATE_IDLE,incomingNumber);
                }
                Log.e(TAG, "------电话挂断---");
                break;
            case TelephonyManager.CALL_STATE_RINGING:   // 电话响铃
                ...
                //if ("on".equals(SharedPreferencesUtils.getParam(MyApp.getContext(), "laidianphone", ""))) {
                    ...
                    if (phoneStateListenerInterface != null && !WatchUtils.isEmpty(incomingNumber)) {
                        phoneStateListenerInterface.callPhoneData(TelephonyManager.CALL_STATE_RINGING,incomingNumber);
                    }
                //}
