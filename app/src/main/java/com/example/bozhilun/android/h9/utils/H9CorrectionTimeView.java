...
public class H9CorrectionTimeView extends View {
    ...
    public H9CorrectionTimeView(Context context, AttributeSet attrs) {
...
//        canvas.drawLine(startX, startY, stopX, stopY, strokePaint);
        ...
        //分针
        int startX = (int) (Math.cos(Math.toRadians(-90 + minuteText * 6 + 6 * secondText / 60f)) * (-30));
        int startY = (int) (Math.sin(Math.toRadians(-90 + minuteText * 6 + 6 * secondText / 60f)) * (-30));
        int stopX = (int) (Math.cos(Math.toRadians(-90 + minuteText * 6 + 6 * secondText / 60f)) * (radius - 100));
        int stopY = (int) (Math.sin(Math.toRadians(-90 + minuteText * 6 + 6 * secondText / 60f)) * (radius - 100));
