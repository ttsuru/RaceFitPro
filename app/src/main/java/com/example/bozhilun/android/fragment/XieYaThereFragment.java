...
public class XieYaThereFragment extends BaseFragment {

    @BindView(R.id.tabs_dtarepot_xieyathere) TabLayout tabs;
    @BindView(R.id.chart_shumian_xieyathere) ColumnChartView stepChart;
    ...
    protected int getContentViewId() {
        return R.layout.fragment_xieyathere;
    }
    ...
    private void getData(String date) {
        ...
        OkHttpObservable.getInstance().getData(commonSubscriber, URLs.HTTPs+URLs.getBloodPressureM, mapjson);
    }
}
