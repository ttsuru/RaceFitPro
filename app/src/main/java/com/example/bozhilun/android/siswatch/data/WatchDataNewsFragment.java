                        ...
                        if (jso.getString("resultCode").equals("001")) {
                            ...
                            if(!weekTag.equals("year")){
                                for (int i = 0; i < watchDataList.size(); i++) {
                                    ...
                                    //x轴值
                                    //mAxisXValues.add(new B18iAxisValue(i).setLabel(watchDataList.get(i).getRtc().substring(5, watchDataList.get(i).getRtc().length())));
                                }
                                showWeekData(); //显示折线图
                            }
                            ...
                            if(!WatchUtils.isEmpty(weekTag)){
                                if(weekTag.equals("week")){
                                    ...
                                    for(int k = 0;k<dateList.size();k++){
                                        ...
                                        //mAxisXValues.add(new B18iAxisValue(k).setLabel(watchDataList.get(i).getRtc().substring(5, watchDataList.get(i).getRtc().length())));
                                    }
                                    showWeekData(); //显示折线图
