...
import com.example.bozhilun.android.fragment.XieYaFragment;
import com.example.bozhilun.android.fragment.XieYaThereFragment;
import com.example.bozhilun.android.fragment.XieyaTwoFragment;
...
public class DataReportItemXieYaActivity extends BaseActivity {
    ...
    @Override
    protected int getStatusBarColor() {return R.color.xieyarorort;}//设置toobar颜色
    @Override
    protected void initViews() {
        tvTitle.setText(getResources().getString(R.string.bloodpressure_repor));
        ...
        fragments.add(new XieYaFragment());
        fragments.add(new XieyaTwoFragment());
        fragments.add(new XieYaThereFragment());
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        toolbar.setOnMenuItemClickListener(new Toolbar.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                ScreenShot.shoot(DataReportItemXieYaActivity.this, new File(filePath));
                Common.showShare(DataReportItemXieYaActivity.this, null, false,filePath);}
                return true;
            }
        });
        return true;
    ...
    protected int getContentViewId() {
        return R.layout.activity_datareport_xieya_item;
    }
}
