...
import com.example.bozhilun.android.B18I.b18irenderer.B18ISlideSelectLineRendererLeafLineRenderer;
import com.example.bozhilun.android.B18I.b18isupport.LeafUtil;
import com.example.bozhilun.android.B18I.b18isupport.OnChartSelectedListener;
import com.example.bozhilun.android.B18I.b18isupport.OnPointSelectListener;
...
public class SlideSelectLineChart extends AbsLeafChart {
    ...
    B18ISlideSelectLineRendererLeafLineRenderer slideRenderer;
    ...
    protected void initRenderer() {
        slideRenderer = new B18ISlideSelectLineRendererLeafLineRenderer(mContext, this);
    }
    ...
    private void countRoundPoint(float x) {
        if (line != null) {
            List<B18iAxisValue> axisXValues = axisX.getValues();
